...
export const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen flex justify-center items-center bg-black text-white font-mono py-20"
    >
      <RevealOnScroll>
        <div className="px-4 w-full max-w-md mx-auto">
          ...
          <form
            className="space-y-6 border-4 border-white p-6 bg-black shadow-[6px_6px_0px_0px_rgba(255,255,255,0.15)]"
          ...
          >
            ...
            <div className="relative">
              <label
                htmlFor="name"
                className="block text-xs uppercase font-bold tracking-wider mb-2 text-white"
              >
                [ INPUT NAME ]
              </label>
              <input
            ...
            {formStatus.message && (
              <div
                className={`border-2 p-3 text-xs font-bold uppercase text-center animate-[pulse_1s_steps(2)_infinite]
