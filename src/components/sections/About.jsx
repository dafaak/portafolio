        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="border-4 border-white bg-black p-6 mb-8 shadow-[6px_6px_0px_0px_rgba(255,255,255,0.15)]">
            <p className="text-white text-sm md:text-base leading-relaxed text-justify mb-8">
              Soy Ingeniero de Software y me apasiona construir productos que
              resuelvan problemas reales.Tengo más de 4 años de experiencia
              desarrollando aplicaciones web, APIs y plataformas SaaS utilizando
              tecnologías como Node.js, NestJS, Go, PostgreSQL y Angular.
              <br />
              <br />
              He trabajado tanto en proyectos empresariales como en productos
              propios, participando en todo el proceso: desde el diseño de la
              arquitectura hasta el despliegue en producción. Disfruto
              especialmente resolver problemas complejos, optimizar sistemas y
            ...
            <div className="border-4 border-white bg-black p-6 shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)]">
              ...
              <ul>
                <li className="text-sm">
                  <strong className="block text-white mb-1 text-base">
                    Ingeniería en Sistemas Informáticos y Computación (2022)
                  </strong>
              ...
              <div className="space-y-6 text-sm">
                <div>
                  ...
                  <span className="text-gray-400 block mb-2">
                    ManticoreLabs (2020 - 2024)
                  </span>
                  <p className="leading-relaxed">
                    Diseñé y desarrollé APIs, aplicaciones empresariales e
                    integraciones entre sistemas utilizando Node.js, NestJS,
                    PostgreSQL y Oracle. Participé en decisiones de
                    arquitectura, optimización de rendimiento e implementación
                    de soluciones cloud con AWS Lambda. Trabajé en la
                    integración de servicios externos, automatización de
                    procesos y desarrollo de funcionalidades escalables para
                    entornos de producción. Optimicé servicios backend y
                    consultas SQL, reduciendo tiempos de respuesta de APIs de 30
                    segundos a 1 segundo.
                  </p>
                </div>
                <div className="border-t border-dashed border-white/50 pt-4">
                  ...
                  <p className="leading-relaxed">
                    Participé en el desarrollo de aplicaciones web utilizando
                    Angular, NestJS y MySQL. Contribuí a la implementación de
                    APIs REST, modelado de datos y desarrollo de componentes
                    reutilizables, trabajando en un entorno ágil basado en
                    Scrum.
                  </p>
                </div>
              </div>
