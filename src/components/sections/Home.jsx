                    ...
                    <div className="w-full max-w-[340px] mx-auto border-2 border-white bg-black p-5 shadow-[10px_10px_0px_0px_rgba(255,255,255,0.2)] mb-12 select-none">
                        ...
                        <div className="flex justify-between items-start px-2 pt-2">
                            ...
                            <div className="relative w-24 h-24 flex items-center justify-center">
                                <div className="absolute w-7 h-20 border-2 border-white bg-black"></div>
                                <div className="absolute h-7 w-20 border-2 border-white bg-black"></div>
                                <div className="absolute w-7 h-7 bg-black z-10"></div>

                                <button onClick={() => navigate("PREV")} className="absolute top-0 w-7 h-7 z-20 active:bg-white cursor-pointer" aria-label="Arriba"></button>
                                <button onClick={() => navigate("NEXT")} className="absolute bottom-0 w-7 h-7 z-20 active:bg-white cursor-pointer" aria-label="Abajo"></button>
                                <button onClick={() => navigate("PREV")} className="absolute left-0 w-7 h-7 z-20 active:bg-white cursor-pointer" aria-label="Izquierda"></button>
                                <button onClick={() => navigate("NEXT")} className="absolute right-0 w-7 h-7 z-20 active:bg-white cursor-pointer" aria-label="Derecha"></button>
                            </div>
