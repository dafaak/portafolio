...
export const Home = () => {
    return (
        <section id="home" className="min-h-screen flex items-center justify-center bg-black text-white font-mono relative">
            <RevealOnScroll>
                ...
                <div className="text-center z-10 px-4">
                    ...
                    {/* Caja de diálogo estilo RPG/Pokémon (Fondo negro, borde blanco grueso) */}
                    ...
                    <div className="flex justify-center mt-8 space-x-6 text-white text-3xl">
                        <a href="https://ghst.tech/linkedin" 
                           target="_blank" 
                           rel="noreferrer"
