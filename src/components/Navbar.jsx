     ...
     backdrop-blur-lg border-b border-white/10 shadow-lg">
        <div className="max-w-5xl mx-auto px-4">
            <div className="flex items-center justify-between h-16 ">
                <a href="#home" className="text-white-500 font-mono text-xl font-bold" >@dafaak</a>
                ...
                <div className="hidden md:flex items-center space-x-8 ml-4">
                    ...
                    <a href="#projects" className="text-gray-300 hover:text-white-700 transition-colors">Projects</a>
                    <a href="#contact" className="text-gray-300 hover:text-white-700 transition-colors">Contact</a>
                </div>
            </div>
        </div>
